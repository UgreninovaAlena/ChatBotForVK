...
import MyLibs.ForDatabase as MyDB
import MyLibs.ForVK as MyVK
...
class SM:
    ...
    def _stop(self, additional_message = None):
        self.change_current_status('stop', additional_message)

    def _input_token(self):
